...
sed -i 's/qr_flutter: \^4\.2\.0/qr_flutter: ^4.1.0/' pubspec.yaml                    # Use known stable version
sed -i 's/flutter_secure_storage: \^8\.2\.0/flutter_secure_storage: ^9.2.4/' pubspec.yaml
sed -i 's/http: \^1\.1\.0/http: ^1.2.1/' pubspec.yaml
sed -i 's/web3dart: \^2\.7\.3/web3dart: ^2.7.3/' pubspec.yaml                       # Keep current
sed -i 's/shared_preferences: \^2\.2\.2/shared_preferences: ^2.3.0/' pubspec.yaml
sed -i 's/walletconnect_dart: \^2\.3\.0/walletconnect_dart: ^2.3.0/' pubspec.yaml   # Keep current
...
sed -i 's/flutter_lints: \^3\.0\.0/flutter_lints: ^3.0.0/' pubspec.yaml             # Keep current
...
sed -i 's/flutter_launcher_icons: "\^0\.13\.1"/flutter_launcher_icons: ^0.13.1/' pubspec.yaml  # Keep current
